...
#define SIGMA_IN prhs[5]
#define SPINS_IN prhs[6]
#define ISRAND_IN prhs[7]
...
void mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[])
{
  ...
  if (nrhs !=8) {
    mexErrMsgTxt("dfwavelet_thresh requires 8 input arguments.");
  }
  ...
  dfwavelet_thresh_SURE_spin(plan,sigma,spins,isRand,out_vx,out_vy,out_vz,in_vx,in_vy,in_vz);
