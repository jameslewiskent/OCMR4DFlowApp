function Lambda2196 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   LAMBDA2196 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   LAMBDA2196 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Lambda2196 = importfile('Lambda2_196.csv', 6, 11612339);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/11/13 13:17:10
